/**
 * Source: https://github.com/kth-competitive-programming/kactl/blob/master/content/geometry/3dHull.h
...
T signed_poly_volume(const vP3& p, const vector<F>& trilist) {
    T v = 0;
