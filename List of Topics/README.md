...
This collection is composed of the algorithms I have needed for USACO contests, plus a few more. See the resources page for larger collections. [CPH](https://cses.fi/book.pdf) refers to the competitive programmer's handbook.
