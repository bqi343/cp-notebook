/**
 * Description: Computes Lyndon Factorization in O(n)
    * A string is "simple" if it is strictly smaller than any of its own nontrivial suffixes
    * Lyndon factorization of the string s is a factorization s=w1w2…wk
    * where all strings wi are simple and w1≥w2≥⋯≥wk
